...
const StatsTab = ({ workouts, getStats }) => {
    ...
    <div className="p-6 space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Analysez vos performances et progression
        </p>
      </div>
          ...
          <div className="space-y-4">
            {workouts
              ...
              .map((workout) => (
                <div
                  key={workout.id}
                  className="flex justify-between items-center py-4 px-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl border border-gray-200 hover:shadow-md transition-shadow duration-200"
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {workout.exercises.length} exercices • {workout.totalSets}{' '}
                      séries
                    </p>
                  </div>
