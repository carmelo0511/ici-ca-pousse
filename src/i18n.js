  ...
  fr: {
    translation: {
      ...
      confirm_delete_workout:
        'Êtes-vous sûr de vouloir supprimer cette séance ? 🗑️',
      ...
      back: 'Retour',
      workout_feeling: 'Comment vous sentez-vous après cette séance ?',
      feeling_easy: 'Facile',
      feeling_medium: 'Moyen',
      feeling_hard: 'Difficile',
      feeling_weak: 'Je me sentais faible',
      feeling_strong: 'Je me sentais fort',
      feeling_tired: 'Fatigué',
      feeling_energized: 'Énergisé',
      feeling_motivated: 'Motivé',
      feeling_demotivated: 'Démotivé',
      feeling_great: 'Excellent',
      feeling_good: 'Bien',
      feeling_ok: 'Correct',
      feeling_bad: 'Pas terrible',
      feeling_terrible: 'Terrible',
      no_feeling: 'Aucun ressenti',
      feeling_placeholder: 'Décrivez vos ressentis...',
      how_did_you_feel: 'Comment vous sentez-vous après cette séance ?',
      custom_feeling: 'Décrivez vos ressentis...',
      save_workout: 'Sauvegarder la séance',
